...
namespace EMS.Plantilla.Core.Reference
{
    ...
    public class ReferenceService : Core.Shared.Utilities, IReferenceService
    {
        ...
        public ReferenceService(PlantillaContext dbContext, IConfiguration iconfiguration,
        ...
        public async Task<IActionResult> GetByRefCodes(APICredentials credentials, List<string> RefCodes)
        {
            ...
            //return new OkObjectResult(SharedUtilities.GetDropdown((await _dbAccess.GetByRefCodes(RefCodes)).ToList(), "ID", "Code", "Title", null));
