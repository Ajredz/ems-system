...
namespace EMS.Security.Core.SystemErrorLog
{
    ...
    public class ErrorLogService : EMS.Security.Core.Shared.Utilities, IErrorLogService
    {
        private readonly IErrorLogDBAccess _dbAccess;

        public ErrorLogService(SystemAccessContext dbContext, IConfiguration iconfiguration,
        ...
        {
            EMS.Security.Data.SystemErrorLog.ErrorLog result = (await _dbAccess.GetByID(ID));
