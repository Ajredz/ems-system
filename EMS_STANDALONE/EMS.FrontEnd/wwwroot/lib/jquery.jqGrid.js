...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		var p = $.extend(true,{
			...
			ExpandColumn: null,
			tree_root_level : 0,
            prmNames: { page:"pageNumber",rows:"rows", sort: "sidx",order: "sord", search:"_search", nd:"nd", id:"id",oper:"oper",editoper:"edit",addoper:"add",deloper:"del", subgridid:"id", npage: null, totalrows:"totalrows"},
			forceFit : false,
			gridstate : "visible",
			cellEdit: false,
			cellsubmit: "remote",
		...
		setPager = function (pgid, tp){
            ...
            if (ts.p.viewrecords === true) {
                ...
                // [PCMS][Added][2019-07-07][custom div for moving elements]
                $("#" + rgt).append("<div id='" + pgid + "_custom_block_right' style='display:inline-flex'></div>");
            }
            $("td#" + pgid + "_" + ts.p.pagerpos, "#" + pgcnt).append(pgl);

            // [PCMS][Added][2019-07-07][move ui-paging-info and ui-pg-selbox into the custom block right]
            $("#" + pgid + " .ui-pg-selbox").appendTo("#" + pgid + "_custom_block_right");
            $("#" + pgid + " .ui-paging-info").appendTo("#" + pgid + "_custom_block_right");

            // [PCMS][Added][2019-07-07][move ViewButtons into the toppagger_left]
            //$(".ViewButtons").appendTo("#" + lft);
