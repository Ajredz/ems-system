...
const WorkflowListURL = "/Recruitment/Workflow?handler=List";
const WorkflowViewURL = "/Recruitment/Workflow/View";
const WorkflowAddURL = "/Recruitment/Workflow/Add";
const WorkflowAddPostURL = "/Recruitment/Workflow/Add";
const WorkflowEditURL = "/Recruitment/Workflow/Edit";
const WorkflowEditPostURL = "/Recruitment/Workflow/Edit";
const WorkflowDeleteURL = "/Recruitment/Workflow/Delete";
const AddApproverRoleDropDownURL = "/Recruitment/Workflow/Add?handler=ApproverRoleDropDown";
const ViewApproverRoleDropDownURL = "/Recruitment/Workflow/View?handler=ApproverRoleDropDown";
const EditApproverRoleDropDownURL = "/Recruitment/Workflow/Edit?handler=ApproverRoleDropDown";
const AddResultTypeDropDownURL = "/Recruitment/Workflow/Add?handler=ResultTypeDropDown";
const ViewResultTypeDropDownURL = "/Recruitment/Workflow/View?handler=ResultTypeDropDown";
const EditResultTypeDropDownURL = "/Recruitment/Workflow/Edit?handler=ResultTypeDropDown";

$(document).ready(function () {
    objWorkflowListJS = {

        Initialize: function () {
            $("#divWorkflowApprovalModal .modal-header").mousedown(handle_mousedown);
            var s = this;
            s.ElementBinding();
            var param = {
        ...
        AddLink: function (cellvalue, options, rowObject) {
            return "<a href=\"\" class='jqgrid-id-link' onclick=\"return LoadPartial('" + WorkflowViewURL + "?ID=" + rowObject.ID + "', 'divWorkflowBodyModal');\">" + rowObject.ID + "</a>"; 
        },
