...
$(document).ready(function () {
    objWorkflowAddJS = {
        ...
        AddWorkflowStepDynamicFields: function () {
            ...
            + "        <span class=\"btn-glyph-dynamic glyphicon glyphicon-trash\" onclick=\"ModalConfirmation(MODAL_HEADER, MSG_CONFIRM_SINGLE, &quot;objWorkflowAddJS.RemoveDynamicFields('#WorkflowStepDynamicFields_" + ctr + "')&quot;, &quot;function&quot;);\"></span>"
            + "    </div>"
            + "</div>"
            );
