    ...
    objUpdateLogActivityJS = {
        ...
        Initialize: function () {
            ...
            $("#divLogActivityModal #ddlType, #divLogActivityModal #ddlStatus, #divLogActivityModal #ddlAssignedOrgGroup, \
                #divLogActivityModal #cbIsPass, #divLogActivityModal #txtAssignedUser, \
                #divLogActivityModal #cbIsAssignToSelf, #divLogActivityModal #txtAssignedOrgGroup, #divLogActivityModal #txtAssignedOrgGroup").attr("disabled", true);
        ...
        ElementBinding: function () {
            ...
            $("#divLogActivityModal #btnEditActivity").click(function () {
                ...
                $("#divLogActivityModal #ddlType, #divLogActivityModal #ddlStatus, #divLogActivityModal #ddlAssignedOrgGroup, \
                    #divLogActivityModal #cbIsPass, #divLogActivityModal #cbIsAssignToSelf, #divLogActivityModal #txtAssignedOrgGroup").attr("disabled", false);
                $("#divLogActivityModal label[for='ddlType'] span, \
                   #divLogActivityModal label[for='ddlTitle'] span, \
                   #divLogActivityModal label[for='txtTitle'] span, \
        ...
        GetFormData: function () {
            ...
            formData.append("ApplicantLogActivityForm.ApplicantID", $("#divApplicantModal #hdnID").val());
            return formData;
        },
        ...
        AttachmentUpdateSuccessFunction: function () {
            LoadPartial(UpdateLogActivityURL + "?ApplicantLogActivityID=" + $("#hdnApplicantLogActivityID").val(), 'divLogActivityBodyModal');
        },
        ...
        GetComment: function () {
            var input = {
                ID: $("#divLogActivityModal #hdnApplicantLogActivityID").val()
            };
            ...
            var GetSuccessFunction = function (data) {
                ...
                var populateFields = function (item, idCtr) {
                    ...
                    $("#DivLogActivityDownloadAttachmentDynamicFields").append(
                        ...
                        + "    </div>"
                        + "     <div class=\"col-md-0-5 no-padding\">"
                        + "         <span class=\"btn-glyph-dynamic glyphicon glyphicon-download-alt\" onclick=\"objEMSCommonJS.DownloadAttachment(CheckFileIfExistsURL, 'RecruitmentService_Attachment_Path','" + item.ServerFile + "', '" + item.SourceFile + "')\"></span>"
                        + "     </div>"
                        + "</div>"
                    );
