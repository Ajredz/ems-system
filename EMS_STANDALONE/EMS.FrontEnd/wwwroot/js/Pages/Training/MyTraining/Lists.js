...
const TrainingListURL = "/Training/MyTraining?handler=List";
const TrainingViewURL = "/Training/MyTraining/View";
const TrainingAddURL = "/Training/MyTraining/Add";
const TrainingEditURL = "/Training/MyTraining/Edit";
const GetStatusURL = "/Training/MyTraining?handler=StatusFilter";
const GetTrainingTypeURL = "/Training/MyTraining?handler=ReferenceValue&RefCode=TRAINING_TYPE";
const GetTrainingTemplateDropdownURL = "/Training/MyTraining?handler=TrainingTemplateDropdown";
const TrainingTemplateByIDURL = "/Training/MyTraining?handler=TrainingTemplateByID";
const AddEmployeeTrainingTemplateURL = "/Training/MyTraining?handler=AddEmployeeTrainingTemplate";
const UploadInsertURL = "/Training/MyTraining?handler=UploadInsert";
const DownloadFormURL = "/Training/MyTraining?handler=DownloadTrainingTemplate";
const TrainingChangeStatus = "/Training/MyTraining?handler=ChangeStatus";
const GetTrainingStatusHistoryURL = "/Training/MyTraining?handler=TrainingStatusHistory";
const GetTrainingScoreURL = "/Training/MyTraining?handler=TrainingScore";
const ExportListURL = "/Training/MyTraining?handler=ExportList";
const ExportDownloadListURL = "/Training/MyTraining?handler=ExportDownloadList";
const GetSystemUserAutoCompleteURL = "/Training/MyTraining?handler=SystemUserAutoComplete";
    ...
    objEmployeeTrainingListJS = {
        ...
        LoadJQGrid: function (param) {
            ...
            $("#tblEmployeeTrainingList").jqGrid({
                ...
                datatype: "json",
                mtype: "GET",
                colNames: ["ID", "Type", "Title", "Status","Date Schedule", "Created By", "Created Date", "Modified By", "Modified Date", "", ""],
                colModel: [
                    {
