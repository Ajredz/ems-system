...
$(document).ready(function () {
    objUpdateLogActivityJS = {
        ...
        Initialize: function () {
            ...
            $("#divLogActivityModal #ddlType, #divLogActivityModal #ddlStatus").attr("disabled", true);
        ...
        ElementBinding: function () {
            ...
            $("#divLogActivityModal #btnEditActivity").click(function () {
                ...
                if (window.location.pathname.indexOf("all") >= 0) {
                    ...
                    $("#divLogActivityModal label[for='ddlType'] span, \
                   #divLogActivityModal label[for='ddlTitle'] span, \
                   #divLogActivityModal label[for='txtTitle'] span").addClass("reqField");
                    $("#divLogActivityModal label[for='ddlType'] span, \
                   #divLogActivityModal label[for='ddlTitle'] span, \
                   #divLogActivityModal label[for='txtTitle'] span").removeClass("unreqField");
                }
                else {
                    //$("#divLogActivityModal #ddlStatus, #divLogActivityModal #txtRemarks").attr("disabled", false);
                    $("#divLogActivityModal #ddlStatus").attr("disabled", false);
                    ...
                    $("#divLogActivityModal #ddlStatus").addClass("required-field");
                }
            ...
            $("#divLogActivityModal #btnBackActivity").click(function () {
                if (window.location.pathname.indexOf("all") >= 0) {
                    $("#divLogActivityModal .form-control").attr("disabled", true);
                    $("#divLogActivityModal .form-control").attr("readonly", true);
                    $("#divLogActivityModal label[for='ddlType'] span, \
                   #divLogActivityModal label[for='ddlTitle'] span, \
        ...
        GetFormData: function () {
            ...
            formData.append("EmployeeLogActivityForm.EmployeeID", $("#hdnID").val());
            return formData;
        },
        ...
        AttachmentUpdateSuccessFunction: function () {
            LoadPartial(UpdateLogActivityURL + "?ID=" + $("#hdnEmployeeLogActivityID").val() + "&EmployeeID=" + $("#hdnEmployeeLogActivityID").val(), 'divLogActivityBodyModal');
        },
        ...
        LoadLogActivityStatusHistoryJQGrid: function (param) {
            ...
            $("#tblLogActivityStatusHistoryList").jqGrid({
                url: GetEmployeeLogActivityStatusHistoryURL,
                postData: param,
                sortname: "",
                sortorder: "",
                selrow: "",
        ...
        GetComment: function () {
            ...
            objEMSCommonJS.GetAjax(GetEmployeeCommentsURL, input, "", GetSuccessFunction);
        },
        ...
        GetAttachment: function () {
            ...
            var GetSuccessFunction = function (data) {
                ...
                var populateFields = function (item, idCtr) {
                    ...
                    $("#DivLogActivityDownloadAttachmentDynamicFields").append(
                        ...
                        + "        <span class=\"btn-glyph-dynamic glyphicon glyphicon-trash\" onclick=\"ModalConfirmation(MODAL_HEADER, MSG_CONFIRM_DELETE_SINGLE, &quot;objUpdateLogActivityJS.RemoveDynamicFields('#LogActivityAttachmentDynamicFields_" + ctr + "',objUpdateLogActivityJS.DeleteAttachmentFunction(&#39;" + item.ServerFile + "&#39;))&quot;, &quot;function&quot;);\"></span>"
                        + "    </div>"
                        + "     <div class=\"col-md-0-5 no-padding\">"
            ...
            objEMSCommonJS.GetAjax(GetEmployeeAttachmentURL, input, "", GetSuccessFunction);
        },

        GetCommentSectionFormData: function () {
            var formData = new FormData($('#frmLogActivity').get(0));
            formData.append("CommentsForm.ApplicantLogActivityID", $("#hdnEmployeeLogActivityID").val());
        ...
        GetAttachmentSectionFormData: function () {
            $(".LogActivity_Attachment_Type").each(function (index) {
                $(this).prop("name", "LogActivityAttachmentForm.AddAttachmentForm[" + index + "].AttachmentType");
            });

            $(".LogActivity_Attachment_Remarks").each(function (index, item) {
                $(this).prop("name", "LogActivityAttachmentForm.AddAttachmentForm[" + index + "].Remarks");
            });

            $(".LogActivity_Attachment_ServerFile").each(function (index, item) {
                $(this).prop("name", "LogActivityAttachmentForm.AddAttachmentForm[" + index + "].ServerFile");
            });

            $(".LogActivity_Attachment_SourceFile").each(function (index, item) {
                $(this).prop("name", "LogActivityAttachmentForm.AddAttachmentForm[" + index + "].SourceFile");
            });

            $(".LogActivity_Attachment_File").each(function (index, item) {
                $(this).prop("name", "LogActivityAttachmentForm.AddAttachmentForm[" + index + "].File");
            });

            var formData = new FormData($('#frmLogActivity').get(0));
            formData.append("LogActivityAttachmentForm.ApplicantLogActivityID", $("#hdnEmployeeLogActivityID").val());

            $(logActivityDeletedAttachments).each(function (index, item) {
                formData.append("LogActivityAttachmentForm.DeleteAttachmentForm[" + index + "].ServerFile", item.value);
            });
            return formData;
        },
        ...
        AddAttachmentDynamicFields: function () {
            ...
            $("#DivLogActivityUploadAttachmentDynamicFields").append(
                ...
                + "    </div>"
                + "    <div class=\"col-md-0-5 no-padding\">"
                + "        <span class=\"btn-glyph-dynamic glyphicon glyphicon-trash\" onclick=\"ModalConfirmation(MODAL_HEADER, MSG_CONFIRM_DELETE_SINGLE, &quot;objUpdateLogActivityJS.RemoveDynamicFields('#LogActivityAttachmentDynamicFields_" + ctr + "')&quot;, &quot;function&quot;);\"></span>"
                + "    </div>"
                + "    <div class=\"col-md-1-5 no-padding\">"
                + "        <select id=\"ddlType_" + ctr + "\" class= \"form-control required-field LogActivity_Attachment_Type\" title=\"Attachment Type\"></select >"
                + "    </div>"
