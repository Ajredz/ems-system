...
$(document).ready(function () {
    objUpdateLogActivityJS = {
        ...
        Initialize: function () {
            ...
            if ($("#lblApplicantCurrentStatus").text() == "DONE" || $("#lblApplicantCurrentStatus").text() == "CANCELLED") {
        ...
        ElementBinding: function () {
            ...
            $("#btnSaveActivity").click(function () {
                ...
                if (objEMSCommonJS.ValidateBlankFields("#frmLogActivity", "#divLogActivityErrorMessage")) {
                    ModalConfirmation(MODAL_HEADER, MSG_CONFIRM,
                        ...
                        , UpdateApplicantLogActivityPostURL \
            ...
            $("#divLogActivityModal #btnBackActivity").click(function () {
                if (window.location.pathname.indexOf("all") >= 0) {
                    ...
                    $("#divLogActivityModal label[for='ddlStatus'] span").removeClass("reqField");
                    $("#divLogActivityModal label[for='ddlStatus'] span").addClass("unreqField");
                }
        ...
        AttachmentUpdateSuccessFunction: function () {
            LoadPartial(UpdateLogActivityURL + "?ID=" + $("#hdnApplicantLogActivityID").val() + "&ApplicantID=" + $("#hdnApplicantID").val(), 'divLogActivityBodyModal');
        },
        ...
        LoadLogActivityStatusHistoryJQGrid: function (param) {
            ...
            $("#tblLogActivityStatusHistoryList").jqGrid({
                url: GetApplicantLogActivityStatusHistoryURL,
                postData: param,
                sortname: "",
                sortorder: "",
                selrow: "",
        ...
        GetAttachment: function () {
            ...
            objEMSCommonJS.GetAjax(GetApplicantAttachmentURL, input, "", GetSuccessFunction);
        },
        ...
        GetAttachmentSectionFormData: function () {
            ...
            var formData = new FormData($('#frmLogActivity').get(0));
            formData.append("AttachmentForm.ApplicantID", $("#hdnApplicantID").val());
