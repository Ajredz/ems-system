...
$(document).ready(function () {
    objOrgHistoryAddJS = {
        ...
        Initialize: function () {
            ...
            $("#txtDateEffective").prop("readonly", false);
        },
        ...
        ElementBinding: function () {
            ...
            $("#closeModal").click(function () {
                ...
                ModalConfirmation(MODAL_HEADER, MSG_CONFIRM_TO_CLOSE,
                    "objOrgHistoryAddJS.CloseModal('true')",
                    "function");
            ...
            $("#btnSave").click(function () {
                if ($("#txtDateEffective").val() != "") {
                    ...
                    ModalConfirmation(MODAL_HEADER, MSG_CONFIRM,
                        "objOrgHistoryAddJS.SendAjax()",
                        "function");

                    /*ModalConfirmation(MODAL_HEADER, MSG_CONFIRM,
                        "objEMSCommonJS.PostAjax(true \
                        , OrgHistoryAddURL \
                        , objOrgHistoryAddJS.GetFormData() \
        ...
        LoadJQGrid: function (IsLatest) {
            ...
            $("#tblOrgHistoryViewList").jqGrid({
                ...
                colModel: [
                    ...
                    { formatter: objOrgHistoryAddJS.AddLink, name: "ParentCodeDescription", index: "ParentCodeDescription", align: "left", sortable: true },
                ...
                /*ondblClickRow: function (rowId, iRow, iCol, e) {
                    ...
                    //objOrgHistoryAddJS.OrgGroupAutoComplete(iRow);
                    //$("#1_ParentCodeDescription").addClass("form-control").css("width", "100%");
                },
                afterEditCell: function (rowid, cellname, value, iRow, iCol) {
                    objOrgHistoryAddJS.BindAutoComplete(iRow + "_ParentCodeDescription"
                ...
                loadComplete: function (data) {
                    ...
                    if (data.rows != null) {
                        $("#txtDateEffective").datetimepicker({
                            ...
                            disabledDates: objEMSCommonJS.removeItemAll($("#hdnNotAllowDate").val().split(","), newformatDateToString(new Date()))
                        });
                        ...
                        $(".EditParent").each(function (index, n) {
                            objOrgHistoryAddJS.BindAutoComplete(n.id
                                , OrgHistoryAutoCompleteURL
                                , 20, "hdnParentOrgID", "ID", "Description", n.value);
                        });
                    }

                    objOrgHistoryAddJS.ShowHideFilter($("#tblOrgHistoryViewList"));
        ...
        SendAjax: function () {
            ...
            $.ajax({
                ...
                url: OrgHistoryAddURL + "?TDate=" + $("#txtDateEffective").val() + "&IsLatest=true",
