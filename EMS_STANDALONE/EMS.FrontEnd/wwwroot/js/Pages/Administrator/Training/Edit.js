...
$(document).ready(function () {
    objTrainingEditJS = {
        ...
        Initialize: function () {
            ...
            var s = this;
            s.ElementBinding();
            $("#divTrainingModal #btnSave, #divTrainingModal #btnBack").show();
        ...
        ElementBinding: function () {
            ...
            $("#divTrainingModal #btnBack").click(function () {
                LoadPartial(TrainingViewURL + "?ID=" + objTrainingEditJS.ID, "divTrainingBodyModal");
            });
            ...
            $("#divTrainingModal #btnSave").click(function () {
                if (objEMSCommonJS.ValidateBlankFields("#formTraining", "#divTrainingErrorMessage")) {
                    ModalConfirmation(MODAL_HEADER, MSG_CONFIRM,
                        ...
                        , TrainingEditURL \
                        , objTrainingEditJS.GetFormData() \
                        , '#divTrainingErrorMessage' \
                        , '#divTrainingModal #btnSave' \
                        , objTrainingEditJS.EditSuccessFunction);",
                        "function");
                }
            });
        },
        ...
        AddTrainingDynamicFields: function () {
            ...
            $("#divTrainingDynamicFields").append(
                ...
                + "        <span class=\"btn-glyph-dynamic glyphicon glyphicon-trash\" onclick=\"ModalConfirmation(MODAL_HEADER, MSG_CONFIRM_DELETE_SINGLE, &quot;objTrainingEditJS.RemoveDynamicFields('#TrainingDynamicFields_" + ctr + "')&quot;, &quot;function&quot;);\"></span>"
                + "    </div>"
        ...
        EditSuccessFunction: function () {
            $("#btnSearch").click();
            $("#divTrainingModal #btnBack").click();
        },
