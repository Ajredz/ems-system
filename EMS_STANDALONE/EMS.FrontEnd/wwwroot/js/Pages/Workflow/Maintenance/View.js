...
$(document).ready(function () {
    objWorkflowViewJS = {
        ...
        GetResultTypeDropDownOptions: function () {
            ...
            objEMSCommonJS.GetAjax(ViewResultTypeDropDownURL, {}, "", GetSuccessFunction);
        },
        ...
        AddWorkflowStepDynamicFields: function () {
            ...
            $("#DivWorkflowStepDynamicFields").append(
                ...
                + "        <input type=\"text\" id=\"txtStepColor_" + ctr + "\" class=\"form-control StepColorDynamicFields\" title=\"Step Color\">"
                + "    </div>"
                + "    <div class=\"col-md-1-5 no-padding\">"
        ...
        LoadWorkflowStep: function () {
            ...
            var GetSuccessFunction = function (data) {
                var populateFields = function (item, idCtr) {
                    ...
                    $("#txtStepColor_" + idCtr).attr("readonly", true);
                    $("#ddlResultType_" + idCtr).attr("readonly", true);
                    $("#chkIsRequired_" + idCtr).attr("readonly", true);
                    $("#chkAllowBackflow_" + idCtr).attr("readonly", true);
                    $("#chkSendEmailToRequester_" + idCtr).attr("readonly", true);
                    $("#chkSendEmailToApprover_" + idCtr).attr("readonly", true);
