...
const EmployeeListURL = "/Plantilla/EmployeeList?handler=List";
const EmploymentStatusDropDownURL = "/Plantilla/EmployeeList?handler=ReferenceValue&RefCode=EMPLOYMENT_STATUS";
const OrgGroupAutoCompleteURL = "/Plantilla/EmployeeList?handler=OrgTypeAutoComplete";
const PositionAutoCompleteURL = "/Plantilla/EmployeeList?handler=PositionAutoComplete";
const OrgGroupByOrgTypeAutoCompleteURL = "/Plantilla/EmployeeList?handler=OrgGroupByOrgTypeAutoComplete";
const GetCheckEmployeeExportListURL = "/Plantilla/EmployeeList?handler=CheckEmployeeExportList";
const DownloadEmployeeExportListURL = "/Plantilla/EmployeeList?handler=DownloadEmployeeExportList";
    ...
    objEmployeeListJS = {
        ...
        LoadJQGrid: function (param) {
            ...
            $("#tblPlantillaEmployeeList").jqGrid({
                ...
                datatype: "json",
                mtype: "GET",
                colNames: ["", "ID", "New Employee ID", "Name", "Org Group", "Position", "Employment Status", "Status Update Date", "Date Hired","Clearance"
                    , "Old Employee ID", "Cluster", "Area", "Region", "Zone"],
                colModel: [
                    { hidden: true },
            ...
            $("#tblPlantillaEmployeeList_toppager_left").after("<label class=\"ui-row-label\" id=\"lblActive\">Show Active Employee</label>");
