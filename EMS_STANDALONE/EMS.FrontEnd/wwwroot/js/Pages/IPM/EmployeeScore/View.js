...
$(document).ready(function () {
    objEmployeeScoreViewJS = {
        ...
        Initialize: function () {
            ...
            $("#divEmployeeScoreModal .form-control").prop("disabled", true);
            ...
            objEmployeeScoreViewJS.LoadEmployeeScoreStatusHistoryJQGrid({
                ID: $("#hdnID").val(),
            });
            ...
            //WIP
            //setTimeout(function () { $("#btnEdit").click() }, 500);
        },
        ...
        ElementBinding: function () {
            ...
            $("#btnEdit").click(function () {
                LoadPartial(EmployeeScoreEditURL +
                    "?ID=" + objEmployeeScoreViewJS.ID, "divEmployeeScoreBodyModal");
            });

            $("#btnEmployeeExport").click(function () {
                ModalConfirmation(MODAL_HEADER, MSG_CONFIRM, "objEmployeeScoreViewJS.ExportFunction()",
                    "function");
            });

            //$(".ui-jqgrid-hbox").width()
            //"ui-jqgrid-htable"
            ...
            $("#btnDelete").click(function () {
                ModalConfirmation(MODAL_HEADER, MSG_CONFIRM_DELETE_SINGLE,
                    ...
                    , EmployeeScoreDeleteURL + '?ID=' + objEmployeeScoreViewJS.ID\
                    , {} \
                    , '#divEmployeeScoreErrorMessage' \
                    , '#btnDelete' \
                    , objEmployeeScoreViewJS.DeleteSuccessFunction);",
                    "function");
            });
        ...
        ExportFunction: function () {
            var parameters = "&ID=" + objEmployeeScoreViewJS.ID
        ...
        LoadEmployeeScore: function (param) {
            ...
            $("#tblIPMEmployeeScoreKPIScoreList").jqGrid({
                ...
                loadComplete: function (data) {
                    ...
                    objEmployeeScoreViewJS.ShowHideFilter();
    ...
    objEmployeeScoreViewJS.Initialize();
