var objEmployeeScoreKeyInViewJS;
...
$(document).ready(function () {
    objEmployeeScoreKeyInViewJS = {
        ...
        Initialize: function () {
            ...
            $("#divEmployeeScoreKeyInModal .form-control").prop("disabled", true);
            ...
            objEmployeeScoreKeyInViewJS.LoadEmployeeScoreStatusHistoryJQGrid({
                ID: $("#hdnID").val(),
            });

            $('#lblRunID').text(objEMSCommonJS.JQGridIDFormat($('#lblRunID').text()));

            objEMSCommonJS.ChangeTab($(".tablinks:nth-child(1)"), 'tabScore', '#divEmployeeScoreKeyInBodyModal');
        },

        DeleteSuccessFunction: function () {
            $("#btnSearch").click();
            $('#divEmployeeScoreKeyInModal').modal('hide');
        },
        ...
        ElementBinding: function () {
            ...
            $("#btnEdit").click(function () {
                LoadPartial(EmployeeScoreKeyInEditURL +
                    "?ID=" + objEmployeeScoreKeyInViewJS.ID, "divEmployeeScoreKeyInBodyModal");
            });

            $("#btnEmployeeExport").click(function () {

                ModalConfirmation(MODAL_HEADER, MSG_CONFIRM, "objEmployeeScoreKeyInViewJS.ExportFunction()",
                    "function");
            });
            ...
            $("#btnDelete").click(function () {
                ModalConfirmation(MODAL_HEADER, MSG_CONFIRM_DELETE_SINGLE,
                    ...
                    , EmployeeScoreDeleteURL + '?ID=' + objEmployeeScoreKeyInViewJS.ID\
                    , {} \
                    , '#divEmployeeScoreErrorMessage' \
                    , '#btnDelete' \
                    , objEmployeeScoreKeyInViewJS.DeleteSuccessFunction);",
                    "function");
            });
        ...
        ExportFunction: function () {
            var parameters = "&ID=" + objEmployeeScoreKeyInViewJS.ID
        ...
        LoadEmployeeScoreJQGrid: function (param) {
            ...
            $("#tblIPMEmployeeScoreKPIScoreList").jqGrid({
                ...
                loadComplete: function (data) {
                    ...
                    objEmployeeScoreKeyInViewJS.ShowHideFilter();
        ...
        KPITotalField: function (cellvalue, options, rowObject) {
            ...
            return "<span class=\"sample\">" + rowObject.Total + "</span>"
                + "<input type=\"hidden\" class=\"TotalDynamicFields\" value=\"" + rowObject.Total + "\">";
        },
    ...
    objEmployeeScoreKeyInViewJS.Initialize();
