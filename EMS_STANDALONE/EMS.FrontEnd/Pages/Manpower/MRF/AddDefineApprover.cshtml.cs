...
{
    public class AddDefineApproverModel : SharedClasses.Utilities
    {
        [BindProperty]
        public EMS.Manpower.Transfer.MRF.Form MRF { get; set; }

        public AddDefineApproverModel(IConfiguration iconfiguration, IWebHostEnvironment env, bool IsAdminAccess = false) : base(iconfiguration, env)
        {
        ...
        public async Task OnGet()
        {
            if (_globalCurrentUser != null)
            {
                ...
                ViewData["OrgGroupSelectList"] = 
                    ...
                    .GetDropDownExcludeByOrgType(new EMS.Manpower.Transfer.DataDuplication.OrgGroup.GetDropDownExcludeByOrgTypeInput
                    { 
                        ID = _globalCurrentUser.OrgGroupID,
                        OrgTypeDelimited = "SECTION",
