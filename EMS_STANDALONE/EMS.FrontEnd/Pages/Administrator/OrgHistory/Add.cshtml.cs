    ...
    public class AddModel : SharedClasses.Utilities
    {
        ...
        public virtual async Task OnGetAsync()
        {
            ...
            var URL = string.Concat(_plantillaBaseURL,
                  _iconfiguration.GetSection("PlantillaService_API_URL").GetSection("OrgGroup").GetSection("GetAllOrgGroupHistory").Value, "?",
            ...
            ViewData["NotAllowDate"] = string.Join(",", (Result.GroupBy(x => x.TDate).ToList()).Select(x => Convert.ToDateTime(x.Key).ToString("dd-MMM-yyyy")));
        }
            ...
            if (IsSuccess) {
                ...
                await new Common_AuditLog(_iconfiguration, _globalCurrentUser, _env)
                    .AddAuditLog(new Security.Transfer.AuditLog.Form
                    {
                        ...
                        Remarks = string.Concat(_globalCurrentUser.Username, " Add Branch Regroup (Date: ",TDate,")"),
                        IsSuccess = true,
