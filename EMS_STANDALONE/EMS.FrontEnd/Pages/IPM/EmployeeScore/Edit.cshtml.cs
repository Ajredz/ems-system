        ...
        public async Task<JsonResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                var URL = string.Concat(_ipmBaseURL,
                   _iconfiguration.GetSection("IPMService_API_URL").GetSection("EmployeeScore").GetSection("Edit").Value, "?",
                ...
                if (IsSuccess)
                {
                    ...
                    {
                        Remarks.Append(string.Concat("Status for Employee Score of ", EmployeeScore.Employee, " changed from ", oldValue.Status, " to ", EmployeeScore.Status, ". "));
                    }
