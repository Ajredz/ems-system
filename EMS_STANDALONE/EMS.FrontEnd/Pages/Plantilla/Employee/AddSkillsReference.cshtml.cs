...
{
    public class AddSkillsReferenceModel : SharedClasses.Utilities
    {
        [BindProperty]
        public Utilities.API.ReferenceMaintenance.ReferenceValue ReferenceValue { get; set; }

        public AddSkillsReferenceModel(IConfiguration iconfiguration, IWebHostEnvironment env) : base(iconfiguration, env)
        { }
