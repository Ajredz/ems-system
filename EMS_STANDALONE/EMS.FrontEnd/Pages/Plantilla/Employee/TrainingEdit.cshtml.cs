...
{
    public class TrainingEditModel : SharedClasses.Utilities
    {
        [BindProperty]
        public EMS.Workflow.Transfer.Training.EmployeeTrainingForm EmployeeTraining { get; set; }

        public TrainingEditModel(IConfiguration iconfiguration, IWebHostEnvironment env) : base(iconfiguration, env)
        { }
