...
namespace EMS.FrontEnd.Pages.Plantilla.Movement
{
    public class IndexModel : SharedClasses.Utilities
    {
        //for movement checker, 43-44, 47-74, 111, 1182-1192, 
        ...
        public void OnGet()
        {
            if (_systemURL != null)
            {
                ViewData["HasUploadFeature"] = _systemURL.Where(x => x.URL.ToUpper().Equals("/PLANTILLA/MOVEMENT/UPLOAD")).Count() > 0 ? "true" : "false";
                ViewData["HasExportFeature"] = _systemURL.Where(x => x.URL.ToUpper().Equals("/PLANTILLA/MOVEMENT/EXPORT")).Count() > 0 ? "true" : "false";
            }
        }
