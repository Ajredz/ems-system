...
namespace EMS.Manpower.Core.SystemErrorLog
{
    ...
    public class ErrorLogService : EMS.Manpower.Core.Shared.Utilities, IErrorLogService
    {
        private readonly IErrorLogDBAccess _dbAccess;

        public ErrorLogService(ManpowerContext dbContext, IConfiguration iconfiguration,
        ...
        {
            EMS.Manpower.Data.SystemErrorLog.ErrorLog result = (await _dbAccess.GetByID(ID));
