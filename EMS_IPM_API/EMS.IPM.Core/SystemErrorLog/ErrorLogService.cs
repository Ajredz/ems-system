...
using EMS.IPM.Transfer.SystemErrorLog;
...
namespace EMS.IPM.Core.SystemErrorLog
{
    ...
    public class ErrorLogService : EMS.IPM.Core.Shared.Utilities, IErrorLogService
    {
        private readonly IErrorLogDBAccess _dbAccess;

        public ErrorLogService(IPMContext dbContext, IConfiguration iconfiguration,
        ...
        {
            EMS.IPM.Data.SystemErrorLog.ErrorLog result = (await _dbAccess.GetByID(ID));
