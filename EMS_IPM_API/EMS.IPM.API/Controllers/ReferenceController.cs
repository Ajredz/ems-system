...
namespace EMS.IPM.API.Controllers
{
    ...
    public class ReferenceController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("get-dropdown")]
        public async Task<IActionResult> GetDropDown([FromQuery] APICredentials credentials, [FromQuery] List<string> RefCodes, string ID)
        {
            return await _service.GetDropDown(credentials, RefCodes, ID).ConfigureAwait(true);
        }
        ...
        [HttpGet]
        [Route("get-by-ref-code")]
        public async Task<IActionResult> GetByRefCode([FromQuery] APICredentials credentials, [FromQuery] string RefCode)
        {
            return await _service.GetByRefCode(credentials, RefCode).ConfigureAwait(true);
        }
    }
}