...
namespace EMS.IPM.Data.Reference
{
    public interface IReferenceDBAccess
    {
        ...
        Task<ReferenceValue> GetValueByRefCode(string RefCode);
    ...
    public class ReferenceDBAccess : IReferenceDBAccess
    {
        ...
        public ReferenceDBAccess(IPMContext dbContext)
        {
        ...
        public async Task<ReferenceValue> GetValueByRefCode(string RefCode)
        {
            return await _dbContext.ReferenceValue.Where(x => x.RefCode.Equals(RefCode)).FirstOrDefaultAsync();
        }
    }
}