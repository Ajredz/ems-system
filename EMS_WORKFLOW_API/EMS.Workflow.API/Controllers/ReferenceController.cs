...
namespace EMS.Workflow.API.Controllers
{
    ...
    public class ReferenceController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("get-by-ref-code-and-value-prefix")]
        public async Task<IActionResult> GetByRefCodeAndValuePrefix([FromQuery] APICredentials credentials, [FromQuery] GetByRefCodeAndValuePrefixInput param)
        {
            return await _service.GetByRefCodeAndValuePrefix(credentials, param).ConfigureAwait(true);
        }
