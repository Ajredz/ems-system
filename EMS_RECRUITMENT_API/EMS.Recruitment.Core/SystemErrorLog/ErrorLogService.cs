...
namespace EMS.Recruitment.Core.SystemErrorLog
{
    ...
    public class ErrorLogService : EMS.Recruitment.Core.Shared.Utilities, IErrorLogService
    {
        private readonly IErrorLogDBAccess _dbAccess;

        public ErrorLogService(RecruitmentContext dbContext, IConfiguration iconfiguration,
        ...
        {
            EMS.Recruitment.Data.SystemErrorLog.ErrorLog result = (await _dbAccess.GetByID(ID));
